    ...
    return (
      <Fragment>
        <Head>
          ...
          <meta name="twitter:image" content="https://infinityapp.co/static/cover.png" />
          <meta name="twitter:card" content="summary_large_image" />

          <meta property="og:title" content={`${pkg.name} — ${pkg.description}`} />
          <meta property="og:description" content={description} />
          <meta property="og:image" content="https://infinityapp.co/static/cover.png" />
          <meta property="og:url" content="https://infinityapp.co" />
